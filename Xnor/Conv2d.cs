    ...
    public class Conv2d : NeuralItem
    {
        ...
        public InternalArray ProcessImageViaDot(InternalArray ar)
        {
            ...
            for (int i = 0; i < data2.Length; i++)
            {
                ...
                var shift = Weight.GetOffset(0) * i;
                Array.Copy(Weight.Data, shift, data2[i], 0, k);
            }

            float[,] result = new float[patches, outChannels];
        ...
        public virtual InternalArray ProcessImageOptimized2(InternalArray ar, int hout, int wout, int c, int hin, int win)
        {
        ...
        internal void AppendToXml(StringBuilder sb)
        {
